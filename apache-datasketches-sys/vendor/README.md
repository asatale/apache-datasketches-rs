...
Only the headers actually compiled (`common/include`, `hll/include`, `theta/include`,
`LICENSE`, `NOTICE`) are copied; `version.hpp.in` is skipped since nothing
in the HLL path includes it.
